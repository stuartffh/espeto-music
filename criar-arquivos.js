...
const arquivos = {
  // FRONTEND CLIENTE
  'frontend-cliente/index.html': `<!doctype html>
<html lang="pt-BR">
  <head>
    <meta charset="UTF-8" />
  ...
  'frontend-cliente/src/main.jsx': `import React from 'react'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  ...
  'frontend-cliente/src/styles/index.css': `@tailwind base;
@tailwind components;
@tailwind utilities;
...
#root {
  ...
  'frontend-cliente/src/App.jsx': `import { Routes, Route } from 'react-router-dom'
...
export default App`,
  ...
  'frontend-cliente/src/services/api.js': `import axios from 'axios';
...
export default api;`,
  ...
  'frontend-cliente/src/services/socket.js': `import { io } from 'socket.io-client';
...
export default socket;`,
  ...
  'frontend-cliente/src/store/useStore.js': `import { create } from 'zustand';
...
export default useStore;`,
  ...
  'frontend-cliente/src/pages/Home.jsx': `import { useState, useEffect } from 'react';
...
export default Home;`,
  ...
  'frontend-cliente/src/pages/Pagamento.jsx': `import { useEffect } from 'react';
...
export default Pagamento;`,
  ...
  'frontend-cliente/.gitignore': `node_modules
dist
.env
.env.local
*.log
.DS_Store`,
  ...
  'frontend-tv/index.html': `<!doctype html>
<html lang="pt-BR">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  ...
  'frontend-tv/src/main.jsx': `import React from 'react'
import ReactDOM from 'react-dom/client'
import App from './App'
import './index.css'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  ...
  'frontend-tv/src/index.css': `@tailwind base;
@tailwind components;
@tailwind utilities;
...
body {
  ...
  'frontend-tv/src/App.jsx': `import { useState, useEffect } from 'react';
...
export default App;`,
  ...
  'frontend-tv/vite.config.js': `import { defineConfig } from 'vite'
...
export default defineConfig({
  ...
  'frontend-tv/tailwind.config.js': `export default {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
  ],
  ...
  'frontend-tv/postcss.config.js': `export default {
  plugins: {
    tailwindcss: {},
    autoprefixer: {},
  },
  ...
  'frontend-tv/.env.example': `VITE_API_URL=http://localhost:3000
VITE_WEBSOCKET_URL=http://localhost:3000`,

  'frontend-tv/.gitignore': `node_modules
dist
.env
.env.local
*.log
...
for (const [caminho, conteudo] of Object.entries(arquivos)) {
  try {
    ...
    console.error(`❌ Erro ao criar ${caminho}:`, error.message);
    erros++;
  }
}

console.log(\`\n🎉 Processo concluído!\`);
console.log(\`   ✅ Arquivos criados: \${criados}\`);
console.log(\`   ❌ Erros: \${erros}\`);

if (erros === 0) {
  console.log(\`\n📦 Próximos passos:\`);
  console.log(\`   1. cd backend && npm install\`);
  console.log(\`   2. cd frontend-cliente && npm install\`);
  console.log(\`   3. cd frontend-tv && npm install\`);
  console.log(\`   4. Configure os arquivos .env\`);
  console.log(\`   5. Execute: npm run dev em cada pasta\n\`);
}
